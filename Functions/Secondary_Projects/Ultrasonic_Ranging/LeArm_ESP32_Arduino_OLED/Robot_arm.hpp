...
#define SERVOS_OFFSET_VALUE				 4096UL	/* 舵机偏差保存的基地址 */
...
class LeArm_t{
    public:
        ...
        */
        ...
        /* id范围[ 1 , 6 ]从上到下顺序 */
        void knot_run(uint8_t group_id, int target_duty, uint32_t time);
        /* id范围[ 1 , 6 ]从上到下顺序 */
        void knot_stop(uint8_t group_id);
        /* 判断舵机是否运动完成 */
        ...
        */
        ...
        void servos_offset_read(void);
        void servos_offset_erase(void);	
        void servos_offset_save(uint8_t* _pdata, uint16_t _size);
    private:
