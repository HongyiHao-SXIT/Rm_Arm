...
typedef enum
{
	APP_OFFSET_READ = 1,
	APP_OFFSET_DOWNLOAD,
	APP_FUNC_MULT_SERVO_MOVE,
	APP_COORDINATE_SET,
	APP_ACTION_GROUP_RUN = 6,
	APP_FULL_ACTION_STOP,
	APP_FULL_ACTION_ERASE,
	APP_ACTION_DOWNLOAD = 25,
	APP_FUNC_NULL
}AppFunctionStatus;
...
private:
	...
	void unpack(void);
	void packet_transmit(AppFunctionStatus cmd);
