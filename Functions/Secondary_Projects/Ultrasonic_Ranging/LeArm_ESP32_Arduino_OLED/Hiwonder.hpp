...
#define SERVO3_RESET_DUTY 				   669
#define SERVO4_RESET_DUTY 				   520
#define SERVO5_RESET_DUTY 				  1276
...
//         int  set_position(uint16_t servo_ID, uint32_t position, uint16_t duration);
//         int  set_angle(uint16_t servo_ID, uint32_t angle, uint16_t duration);
        
//         int  read_position(uint16_t servo_ID);
//         int  read_angle(uint16_t servo_ID);
//         int  set_offset(uint16_t servo_ID, int offset);
//         int  save_offset(void);
//         void deinit(void);
