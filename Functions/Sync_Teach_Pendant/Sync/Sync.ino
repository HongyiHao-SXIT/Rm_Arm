...
#else
          if(i == 1){
            lsc.moveServo(i, PosConvert(pos[i], SERVO_TYPE_BUS, 500, true), t);
          }else if(i == 4){
              lsc.moveServo(i, PosConvert(pos[i], SERVO_TYPE_BUS, 500, true), t);
          }else if(i == 5){
            lsc.moveServo(i, PosConvert(pos[i], SERVO_TYPE_BUS, 500, true), t);
          }else{
            lsc.moveServo(i, PosConvert(pos[i]), t);
          }
#endif
          break;
        case MODE_Tankbot:
         ...
         case MODE_WonderArm:
          if(i == 1){
            lsc.moveServo(i, PosConvert(pos[i], SERVO_TYPE_BUS, 500, false, 4, -230), t);
          }else if(i == 4){
              lsc.moveServo(i, PosConvert(pos[i], SERVO_TYPE_BUS, 500, false, 1.0), t);
          }else if(i == 5){
            lsc.moveServo(i, PosConvert(pos[i], SERVO_TYPE_BUS, 500, false, 1.0), t);
...
void LedHandle()
{
  ...
  if(millis()-time_count > 100){
    ...
    if(blink_time_now <= blink_times*3){
      if(blink_time_now % 3 == 1)
