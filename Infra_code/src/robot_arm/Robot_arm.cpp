...
{
if(servo_type == 0){
	knot_run(6, SERVO6_RESET_DUTY_PWM_SERVO, time);
	knot_run(5, SERVO5_RESET_DUTY_PWM_SERVO, time);
	knot_run(4, SERVO4_RESET_DUTY_PWM_SERVO, time);
	knot_run(3, SERVO3_RESET_DUTY_PWM_SERVO, time);
	knot_run(2, SERVO2_RESET_DUTY_PWM_SERVO, time);
	knot_run(1, SERVO1_RESET_DUTY_PWM_SERVO, time);
}else{
	knot_run(6, 500, SERVO6_RESET_DUTY_SERIAL_SERVO);
	knot_run(5, 408, SERVO5_RESET_DUTY_SERIAL_SERVO);
	knot_run(4, 129, SERVO4_RESET_DUTY_SERIAL_SERVO);
	knot_run(3, 177, SERVO3_RESET_DUTY_SERIAL_SERVO);
	knot_run(2, 500, SERVO2_RESET_DUTY_SERIAL_SERVO);
	knot_run(1, 226, SERVO1_RESET_DUTY_SERIAL_SERVO);
}
}
