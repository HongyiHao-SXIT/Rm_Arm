...
DRAM_ATTR pwm_servo_obj_t pwm_servos[6] = {
    {.pin_id = SERVO_6, .current_pulsewidth = SERVO6_RESET_DUTY_PWM_SERVO, .actual_pulsewidth = SERVO6_RESET_DUTY_PWM_SERVO, .pulsewidth_changed = false, .is_running = false, .target_pulsewidth = SERVO6_RESET_DUTY_PWM_SERVO},
    {.pin_id = SERVO_5, .current_pulsewidth = SERVO5_RESET_DUTY_PWM_SERVO, .actual_pulsewidth = SERVO5_RESET_DUTY_PWM_SERVO, .pulsewidth_changed = false, .is_running = false, .target_pulsewidth = SERVO5_RESET_DUTY_PWM_SERVO},
    {.pin_id = SERVO_4, .current_pulsewidth = SERVO4_RESET_DUTY_PWM_SERVO, .actual_pulsewidth = SERVO4_RESET_DUTY_PWM_SERVO, .pulsewidth_changed = false, .is_running = false, .target_pulsewidth = SERVO4_RESET_DUTY_PWM_SERVO},
    {.pin_id = SERVO_3, .current_pulsewidth = SERVO3_RESET_DUTY_PWM_SERVO, .actual_pulsewidth = SERVO3_RESET_DUTY_PWM_SERVO, .pulsewidth_changed = false, .is_running = false, .target_pulsewidth = SERVO3_RESET_DUTY_PWM_SERVO},
    {.pin_id = SERVO_2, .current_pulsewidth = SERVO2_RESET_DUTY_PWM_SERVO, .actual_pulsewidth = SERVO2_RESET_DUTY_PWM_SERVO, .pulsewidth_changed = false, .is_running = false, .target_pulsewidth = SERVO2_RESET_DUTY_PWM_SERVO},
    {.pin_id = SERVO_1, .current_pulsewidth = SERVO1_RESET_DUTY_PWM_SERVO, .actual_pulsewidth = SERVO1_RESET_DUTY_PWM_SERVO, .pulsewidth_changed = false, .is_running = false, .target_pulsewidth = SERVO1_RESET_DUTY_PWM_SERVO},
};
